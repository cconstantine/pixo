...
namespace Pixlib {
  ...
  void LedRender::render(const Texture& texture, const IsoCamera& perspective, float brightness, float gamma, uint8_t* buffer, size_t size) {
    ...
    leds->draw(texture, perspective, brightness, gamma);
